...
public class Line extends JComponent {
	...
	Point p1 = getEdgeIntersectionPoint(L1.getSize(), L1.getLocation(), centers1, m);
	double[] centers2 = { c, d, a, b };
	Point p2 = getEdgeIntersectionPoint(L2.getSize(), L2.getLocation(), centers2, m);
    ...
    // L2
    private static Point getEdgeIntersectionPoint(Dimension d1, Point p1, double[] centers, double m) {
