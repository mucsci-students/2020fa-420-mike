...
public class guiHelperMethods {
	...
	public static void createClass (Classes classes, Classes userClasses) {
	...
	public static void createOrDeleteRelation(Classes classes, JComboBox<String> list, String function, String[] entityStrings) {
	...
	public static void createFieldsOrMethods(Classes classes, JComboBox<String> list, String attribute) {
    	...
    	// Ask for input with inputFields
        int result = JOptionPane.showConfirmDialog(null, inputFields, 
                "Create " + attribute, JOptionPane.OK_CANCEL_OPTION);
	...
	public static void renameFieldsOrMethods(Classes classes, JComboBox<String> list, JFrame frame, String attribute) {
    	...
    	JComboBox<String> finaleList = inputClass(classes.getEntities(), frame, attribute, false, "Rename " + attribute);
    	if (finaleList == null) {
    		return;
    	}
        ...
        int result2 = JOptionPane.showConfirmDialog(null, inputFields2, 
                "Rename " + attribute, JOptionPane.OK_CANCEL_OPTION);
	...
	public static void deleteFieldsOrMethods(Classes classes, JComboBox<String> list, JFrame frame, String attribute) {
		// Create a window asking for which class to choose from
    	JComboBox<String> finaleList = inputClass(classes.getEntities(), frame, attribute, false, "Delete " + attribute);
    	if (finaleList == null) {
    		return;
    	}
    	// Create Drop-down box of existing classes
    	...
    	// Ask for input with inputFields
        int result2 = JOptionPane.showConfirmDialog(null, inputFields2, 
                "Delete " + attribute, JOptionPane.OK_CANCEL_OPTION);
	...
	public static void createParameter(Classes classes, JComboBox<String> list, JFrame frame) {
		...
		if (result2 == 0) {
			String entityname = list.getSelectedItem().toString();
			classes.createParameter(finaleList.getSelectedItem().toString(), methodList.getSelectedItem().toString(), name.getText(), type.getText());
			View.updateClass(entityname, classes.copyEntity(entityname));
		}
	}
	...
	public static void renameParameter(Classes classes, JComboBox<String> list, JFrame frame) {
    	...
    	if (result3 == 0) {
    		String entityname = list.getSelectedItem().toString();
    		classes.renameParameter(finaleList.getSelectedItem().toString(), methodList.getSelectedItem().toString(), parameterList.getSelectedItem().toString(), name.getText());
    		View.updateClass(entityname, classes.copyEntity(entityname));
    	}
	}
	...
	public static void deleteParameter(Classes classes, JComboBox<String> list, JFrame frame) {
    	...
    	if (result3 == 0) {
    		String entityname = list.getSelectedItem().toString();
    		classes.deleteParameter(finaleList.getSelectedItem().toString(), methodList.getSelectedItem().toString(), parameterList.getSelectedItem().toString());
    		View.updateClass(entityname, classes.copyEntity(entityname));
    	}
	}
	...
	public static void load(String userPath, Classes userClasses) throws FileNotFoundException, IOException, ParseException, org.json.simple.parser.ParseException {
