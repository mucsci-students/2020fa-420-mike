...
public class HtmlBox {
    ...
    public HtmlBox(Entity entity, GUIController control) {
        ...
        System.out.println(this.newBox.getPreferredSize().width);
        //System.out.println(this.newBox.getPreferredSize().height);
        // Create border and margin
        Border border = BorderFactory.createLineBorder(Color.BLACK, 2);
        Border margin = new EmptyBorder(6, 6, 6, 6);
        newBox.setBorder(new CompoundBorder(border, margin));
        
        //newBox.setPreferredSize(new Dimension(this.newBox.getPreferredSize().width, this.newBox.getPreferredSize().height));
        // Create settings so the box can appear at right spot
        newBox.setBounds(0, 0, this.newBox.getPreferredSize().width, this.newBox.getPreferredSize().height);
        newBox.setLocation(entity.getXLocation(), entity.getYLocation());
        System.out.println(this.newBox.getPreferredSize().width);
        //System.out.println(this.newBox.getPreferredSize().height);
        System.out.println();
