...
public class HelperMethodsTest {
    ...
    public void listClassesTest() {
		...
		assertEquals("Print of empty class is incorrect", expected, actual);
        resetStreams();
        ...
        HelperMethods.listClasses(model);
		actual = out.toString();
		assertEquals("Print of two empty classes is incorrect", expected, actual);
        resetStreams();

		model.deleteClass("c2");
		...
		System.out.println("\t+---------------+");
		System.out.println("\t| Fields:       |");
		System.out.println("\t| PUBLIC int f1 |");
		System.out.println("\t+---------------+");
		System.out.println("\t| Methods:      |");
		System.out.println("\t+---------------+");
        ...
        HelperMethods.listClasses(model);
		actual = out.toString();
		assertEquals("Print of class with field is incorrect", expected, actual);
        resetStreams();

		//test method (and field)
		...
		System.out.println("\t+----------------------+");
		System.out.println("\t| Methods:             |");
		System.out.println("\t| PRIVATE boolean m1() |");
		System.out.println("\t+----------------------+");
        ...
        HelperMethods.listClasses(model);
		actual = out.toString();
		assertEquals("Print of class with empty method is incorrect", expected, actual);
        resetStreams();

		//test parameter (and field)
		...
		System.out.println("\t+-------------------------------+");
		System.out.println("\t| Methods:                      |");
		System.out.println("\t| PRIVATE boolean m1(String p1) |");
		System.out.println("\t+-------------------------------+");
        ...
        HelperMethods.listClasses(model);
		actual = out.toString();
		assertEquals("Print of class with method with one parameter is incorrect", expected, actual);
        resetStreams();

		//test another class with multiple of everything
		model.createClass("c2");
		model.createField("c2", "field1", "double", "protected");
		model.createField("c2", "field2", "String", "private");
		model.createMethod("c2", "method1", "ArrayList<JSONObject>", "public");
		model.createMethod("c2", "method2", "int[]", "private");
		model.createParameter("c2", "method2", "param1", "bool");
		model.createParameter("c2", "method2", "param2", "char");
		...
		System.out.println("\t+-------------------------------------------------+");
		System.out.println("\t| Fields:                                         |");
		System.out.println("\t| PROTECTED double field1                         |");
		System.out.println("\t| PRIVATE String field2                           |");
		System.out.println("\t+-------------------------------------------------+");
		System.out.println("\t| Methods:                                        |");
		System.out.println("\t| PUBLIC ArrayList<JSONObject> method1()          |");
		System.out.println("\t| PRIVATE int[] method2(bool param1, char param2) |");
		System.out.println("\t+-------------------------------------------------+");
