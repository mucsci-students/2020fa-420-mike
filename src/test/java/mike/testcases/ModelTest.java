...
public class ModelTest {
    ...
    public void testContainsEntity()
    {
        Model model = new Model();
        model.createClass("e");
        assertTrue("Found entity 'e'", model.containsEntity("e"));
        assertFalse("False for non-existing entity", model.containsEntity("fake"));
    }
    ...
    public void testContainsRelationship()
    {
        ...
        assertFalse("False for non-existent entity1 name", model.containsRelationship(Type.INHERITANCE, "fake", "e2"));
        assertFalse("False for non-existent entity2 name", model.containsRelationship(Type.INHERITANCE, "e", "fake"));
        assertFalse("False when pairs are in wrong order", model.containsRelationship(Type.INHERITANCE, "e2", "e"));
        
        model.renameClass("e", "e1");
        
        assertTrue("Found relationship after entity1 name was updated", model.containsRelationship(Type.INHERITANCE, "e1", "e2"));
        model.renameClass("e2", "c2");
        assertTrue("Found relationship after entity2 name was updated", model.containsRelationship(Type.INHERITANCE, "e1", "c2"));
    }
    ...
    public void testGetRelationship()
    {
        ...
        assertEquals("Entity1 names are equal", "e", r.getFirstClass());
        assertEquals("Entity2 names are equal", "e2", r.getSecondClass());
    ...
    public void testCreateClass()
    {
        ...
        assertFalse("createClass returned false after called with name of existing entity", model.createClass("E1"));
    ...
    public void testRenameClass()
    {
        ...
        assertFalse("renameClass returned false after called with name of non-existing entity", model.renameClass("Non-exist", "e"));
        ...
        assertFalse("renameClass returned false after renaming to already existing entity", model.renameClass("E1", "E2"));
        ...
        assertTrue("Entity renamed to e", model.containsEntity("e"));
        assertFalse("Entity E1 no longer exists", model.containsEntity("E1"));
        ...
        assertTrue("Entity E2 renamed to e2", model.renameClass("E2", "ent2"));

        assertFalse("Old relationship no longer exists", model.containsRelationship(Type.REALIZATION, "e", "E2"));
        assertTrue("Entity name (2) in relationship was updated", model.containsRelationship(Type.REALIZATION, "e", "ent2"));

        model.renameClass("e", "e1");
        assertTrue("Entity name (1) in relationship was updated", model.containsRelationship(Type.REALIZATION, "e1", "ent2"));
    ...
    public void testDeleteClass()
    {
        ...
        assertFalse("False when deleting non-existent entity", model.deleteClass("fake"));

        model.deleteClass("e");
        assertFalse("Entity e no longer exists", model.containsEntity("e"));
        ...
        assertTrue("Entity 'cla' has been deleted", model.deleteClass("cla"));
        assertFalse("Entity 'cla' no longer exists", model.containsEntity("cla"));
        assertEquals("Entities list size is 0", 0, model.getEntities().size());
    ...
    public void testCreateField()
    {
        ...
        assertFalse("False when creating field for non-existent entity", model.createField("fake", "a", "int"));

        assertTrue("Added field 'a' for entity 'e'", model.createField("e", "a", "int"));
    ...
    public void testRenameField()
    {
        ...
        assertFalse("False when renaming Field from non-existent entity", model.renameField("fake", "a", "aa"));
    ...
    public void testDeleteField()
    {
        ...
        assertFalse("False when deleting Field from non-existent entity", model.deleteField("fake", "a"));
    ...
    public void testCreateMethod()
    {
        ...
        assertFalse("False when creating method for non-existent entity", model.createMethod("fake", "a", "int"));
    ...
    public void testRenameMethod()
    {
        ...
        assertFalse("False when renaming method from non-existent entity", model.renameMethod("fake", "a", "aa"));
    ...
    public void testDeleteRelationship()
    {
        ...
        assertFalse("False when deleting non-existent relationship (entity1)", model.deleteRelationship(Type.REALIZATION, "fake", "e2"));
        assertFalse("False when deleting non-existent relationship (entity2)", model.deleteRelationship(Type.REALIZATION, "e", "fake"));
